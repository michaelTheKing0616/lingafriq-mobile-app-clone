                        ...
                        return PanAfricanButton(
                          ...
                          onPressed: () async {
                            if (quiz.length == 1) {
                              ...
                              if (correct) {
                                ...
                                await ref.read(gamificationProvider.notifier).awardXP(
                                  ...
                                  sourceId: 'quiz_${quiz.first.question}',
                                );
                            ...
                            if (isTakeQuiz && index == quiz.length - 1) {
                              ...
                              if (allCorrect) {
                                // Award XP with combo multiplier at quiz completion
                                final multiplier = comboTracker.currentMultiplier;
                                await ref.read(gamificationProvider.notifier).awardXP(
                                  'quiz_complete',
                                  multiplier: multiplier,
                                  sourceId: 'quiz_${title}_${DateTime.now().millisecondsSinceEpoch}',
                                );
                            ...
                            if (index == quiz.length - 1) {
                              // Award XP with combo multiplier when navigating to answers screen
                              final multiplier = comboTracker.currentMultiplier;
                              await ref.read(gamificationProvider.notifier).awardXP(
                                'quiz_complete',
                                multiplier: multiplier,
