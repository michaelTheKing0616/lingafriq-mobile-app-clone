...
class RandomQuizLessonModel {
  ...
  RandomQuizLessonModel copyWith({
    int? id,
    String? title,
    int? score,
    String? types,
  ...
  factory RandomQuizLessonModel.fromMap(Map<String, dynamic> map) {
    return RandomQuizLessonModel(
      id: map['id']?.toInt() ?? 0,
      title: map['title'] ?? '',
  ...
  factory RandomQuizLessonModel.fromJson(String source) =>
      RandomQuizLessonModel.fromMap(json.decode(source));
  ...
  bool operator ==(Object other) {
    ...
    return other is RandomQuizLessonModel &&
        other.id == id &&
        other.title == title &&
        other.score == score &&
        other.types == types &&
  ...
  bool get isQuiz => types == 'Instant Question' || types == "Instant Quiz";
  bool get isTutorial => types == 'Tutorial';
  bool get isWordQuiz => types == 'Word Question';
}
