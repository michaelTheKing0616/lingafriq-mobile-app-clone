          ...
          children: [
            ...
            FilledButton(
                  ...
                  : () async {
                      ...
                      if (titleController.text.isEmpty) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text('Please fill in quiz title', style: PanAfricanTypography.bodyMedium(context, color: Colors.white)),
                      ...
                      await safeAsync(
                        ...
                        operation: () async {
                          ...
                          if (context.mounted) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text('Quiz created successfully!', style: PanAfricanTypography.bodyMedium(context, color: Colors.white)),
              ...
              child: isSubmitting.value
                  ...
                  : Text('Create Quiz', style: PanAfricanTypography.labelLarge(context, color: Colors.white)),
            ),
          ],
        ),
      ),
              ...
              children: [
                ...
                Expanded(
                  child: FilledButton(
                    ...
                    child: Text('Add Question', style: PanAfricanTypography.labelLarge(context, color: Colors.white)),
                  ),
                ),
              ],
            ),
