          ...
          children: [
            ...
            FilledButton(
              onPressed: isSubmitting.value ? null : () async {
                ...
                if (titleController.text.isEmpty || storyController.text.isEmpty) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('Please fill in title and story content', style: PanAfricanTypography.bodyMedium(context, color: Colors.white)),
                ...
                await safeAsync(
                  ...
                  operation: () async {
                    ...
                    if (context.mounted) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text('Story created successfully!', style: PanAfricanTypography.bodyMedium(context, color: Colors.white)),
              ...
              child: isSubmitting.value
                  ...
                  : Text('Create Story', style: PanAfricanTypography.labelLarge(context, color: Colors.white)),
            ),
          ],
        ),
      ),
