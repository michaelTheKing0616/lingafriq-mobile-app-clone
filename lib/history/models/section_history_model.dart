...
class SectionHistoryModel {
  ...
  factory SectionHistoryModel.fromMap(Map<String, dynamic> map) {
    return SectionHistoryModel(
      id: map['id']?.toInt() ?? 0,
      title: map['title'] ?? '',
  ...
  factory SectionHistoryModel.fromJson(String source) =>
      SectionHistoryModel.fromMap(json.decode(source));
  ...
  bool operator ==(Object other) {
    ...
    return other is SectionHistoryModel &&
        other.id == id &&
        other.title == title &&
        other.score == score &&
        other.types == types &&
