class Api {
  ...
  static const String tokenRefresh = "accounts/auth/jwt/refresh/";
  static const String tokenVerify = "accounts/auth/jwt/verify/";
  ...
  // Health/Telemetry/User content (used by backend health checks & services)
  static const String gameSessionStart = "/api/game-session/start";
  static const String sendTelemetry = "/api/telemetry";
  static const String getUserContent = "/api/user-content";

  // Games / voice contribution endpoints (used by app features)
  static const String submitGameCompletion = "/api/games/completion";
  static const String submitVoiceContribution = "/api/voice/contributions";
}
